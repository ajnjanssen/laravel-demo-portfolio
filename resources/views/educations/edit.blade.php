    ...
    <section class="w3-padding">
        ...
        <form method="post" action="/console/educations/edit/{{ $education->id }}" novalidate class="w3-margin-bottom">
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="title" name="school" id="school"
                    value="{{ old('school', $education->school) }}" required />
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="text" name="type" id="type"
                    value="{{ old('type', $education->type) }}" />
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="text" name="course" id="course"
                    value="{{ old('started', $education->course) }}" required />
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="date" name="started" id="started"
                    value="{{ old('started', date('Y-m-d', strtotime($education->started))) }}" required />
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="date" name="finished" id="finished"
                    value="{{ old('finished', date('Y-m-d', strtotime($education->finished))) }}" />
            ...
            <div class="w3-half w3-center" style="padding-top: 20px">
                <button type="submit" class="btn btn-secondary" style="width: 200px">Edit Education</button>
            </div>
        </form>
