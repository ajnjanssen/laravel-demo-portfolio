    ...
    <section class="w3-padding">
        ...
        <form method="post" action="/console/jobs/edit/{{ $job->id }}" novalidate class="w3-margin-bottom">
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="text" name="workplace" id="workplace"
                    value="{{ old('workplace', $job->workplace) }}" required />
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="text" name="title" id="title"
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="text" name="address" id="address"
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="date" name="started" id="started"
                    value="{{ old('started', date('Y-m-d', strtotime($job->started))) }}" />
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border w3-round-large" type="date" name="finished" id="finished"
                    value="{{ old('finished', date('Y-m-d', strtotime($job->finished))) }}" />
            ...
            <div class="w3-half w3-center" style="padding-top: 20px">
                <button type="submit" class="btn btn-secondary" style="width: 200px">Edit Job</button>
            </div>
        </form>
